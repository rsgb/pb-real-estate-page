 ...
 *      and — when the caller passes `pdfNamesPresent` — actual presence.
 ...
 *   `pdfNamesPresent` — the PDF basenames known to exist (public/briefs on
 *   disk, or the files Paulo picked in the browser). Omit to skip the check.
